...
public:
    ...
    void retranslateUi(QWidget *AddUserItem)
    {
        ...
        message_tip->setText(QCoreApplication::translate("AddUserItem", "\346\237\245\346\211\276uid/nike", nullptr));
