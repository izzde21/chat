...
public:
    ...
    void setupUi(QDialog *AddFriend)
    {
        ...
        AddFriend->resize(361, 621);
        AddFriend->setMinimumSize(QSize(361, 621));
        AddFriend->setMaximumSize(QSize(361, 621));
        verticalLayout = new QVBoxLayout(AddFriend);
        verticalLayout->setSpacing(0);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 40);
        scrollArea = new QScrollArea(AddFriend);
        scrollArea->setObjectName("scrollArea");
        scrollArea->setWidgetResizable(true);
        scrollcontent = new QWidget();
        scrollcontent->setObjectName("scrollcontent");
        scrollcontent->setGeometry(QRect(0, 0, 359, 437));
        horizontalLayout_5 = new QHBoxLayout(scrollcontent);
        ...
        lb_ed->setGeometry(QRect(6, 6, 114, 19));
        lb_ed->setMinimumSize(QSize(0, 0));
        lb_ed->setMaximumSize(QSize(16777215, 35));
        lb_ed->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        horizontalLayout_5->addWidget(apply_wid);
        ...
        widget_2 = new QWidget(AddFriend);
        widget_2->setObjectName("widget_2");
        horizontalLayout_3 = new QHBoxLayout(widget_2);
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        apply_sure_wid = new QWidget(widget_2);
        ...
        horizontalLayout_3->addWidget(apply_sure_wid);
    ...
    void retranslateUi(QDialog *AddFriend)
    {
        ...
        label->setText(QCoreApplication::translate("AddFriend", "\345\217\221\351\200\201\346\267\273\345\212\240\346\234\213\345\217\213\347\224\263\350\257\267", nullptr));
        label_2->setText(QCoreApplication::translate("AddFriend", "\345\244\207\346\263\250\345\220\215", nullptr));
        label_3->setText(QCoreApplication::translate("AddFriend", "\346\240\207\347\255\276", nullptr));
        tip_lb->setText(QCoreApplication::translate("AddFriend", "TextLabel", nullptr));
        more_lb->setText(QString());
        sure_btn->setText(QCoreApplication::translate("AddFriend", "\347\241\256\350\256\244", nullptr));
        cancel_btn->setText(QCoreApplication::translate("AddFriend", "\345\217\226\346\266\210", nullptr));
    } // retranslateUi
