...
BubbleFrame::BubbleFrame(ChatRole role,QWidget* parent):QFrame(parent),m_margin(3),m_role(role){
    ...
    if(m_role == ChatRole::Self)
    {
        ...
        m_pHLayout->setContentsMargins(WIDTH_SANJIAO + m_margin, 2, m_margin, m_margin);
    }
