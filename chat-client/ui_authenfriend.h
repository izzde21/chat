...
public:
    ...
    void setupUi(QDialog *AuthenFriend)
    {
        ...
        scrollcontent->setGeometry(QRect(0, 0, 392, 345));
        ...
        widget_2 = new QWidget(AuthenFriend);
    ...
    void retranslateUi(QDialog *AuthenFriend)
    {
        ...
        label->setText(QCoreApplication::translate("AuthenFriend", "\345\217\221\351\200\201\346\267\273\345\212\240\346\234\213\345\217\213\347\224\263\350\257\267", nullptr));
